...
public class EncryptDecryptAspect {
     ...
     */
    @Before("@annotation(com.variousdemo.annotations.encrypt_decrypt.EncryptDecryptMethod) && execution(* *(..))")
     ...
     * @param result
     */
    // @AfterReturning(pointcut = "@annotation(com.variousdemo.annotations.encrypt_decrypt.EncryptDecryptFields)", returning = "result")
